...
namespace AutoTerminal.Commands
{
    ...
    internal sealed class OpenTerminalCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenTerminalCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in OpenTerminalCommand's constructor requires
            // the UI thread.
